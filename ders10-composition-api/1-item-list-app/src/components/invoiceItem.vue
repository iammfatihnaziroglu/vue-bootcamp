<template>
  <div class="table-body-item group">
    <input v-model="item.name" autocomplete="off" type="text" class="input w-[100px] mr-2" />
    <input v-model="item.qty" autocomplete="off" type="text" class="input w-[75px] mr-2" />
    <input v-model="item.unit_price" autocomplete="off" type="text" class="input w-[50px] mr-2" />
