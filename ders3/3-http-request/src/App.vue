<template>
  <div class="container">
    <h3 class="text-center" >Alışveriş Listesi</h3>
    <hr />
    <div class="my-2">
      <input type="text" class="text-center" placeholder="Ne Alacaksın?" @keydown.enter="onSave" />
    </div>
    ...
    <div v-else class="text-center">Herhangi bir ürün yok.</div>
    <small
      class="mt-2 text-red d-flex justify-content-end align-items-center"
    >{{ itemCount }} adet alınacak ürün var.</small>
  </div>
</template>
